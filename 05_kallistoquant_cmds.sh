...
kallisto quant -b 100 -i /work/02189/rmharris/SingleNeuronSeq/data/reference_genomes/combo.idx  -o /scratch/02189/rmharris/SingleNeuronSeq/results/05_kallistoquant_2016-03-24/${samp} $R1 $R2
EOF
done
