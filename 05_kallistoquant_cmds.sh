...
mkdir /scratch/02189/rmharris/SingleNeuronSeq/results/JA16393/2016-06-27-kallistoquant
...
## now, create 2016-06-27-kallistoquant.cmds 

for R1 in *R1_001.fastq.gz; do
    R2=$(basename $R1 R1_001.fastq.gz)R2_001.fastq.gz
    samp=$(basename $R1 _R1_001.fastq.gz)
    echo $R1 $R2 $samp
    cat >> 2016-06-27-kallistoquant.cmds <<EOF
kallisto quant -b 100 -i /scratch/02189/rmharris/Cborealis_ref/Cborealis_transcriptome.idx  -o /scratch/02189/rmharris/SingleNeuronSeq/results/JA16393/2016-06-27-kallistoquant/${samp} $R1 $R2
EOF
done


## check number of lines in commands file
wc 2016-06-27-kallistoquant.cmds
